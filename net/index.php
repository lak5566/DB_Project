...
<body>
    <div id="sitebody">
        <div id="header">
            <h1>珍愛地球系統</h1>
            <p  align="right">
                <a href="ad_setting.php">設定</a>
                <a href="MyItem.php">我的交換物</a>
                <a href="Change.php">物品交換</a>
                <a href="Record.php">交易紀錄</a>
                <a href="MyLove.php">我的最愛</a>
            </p>
        </div>
        <div id="sidebar_left">
            <h4>全站分類</h4>
        ...
        <div id="sidebar_right">
            <h4>您好，XXX</h4><br><br>
            <input type="button" value="登出" onclick="location.href='pre_index.php'">
        </div>
        <div id="content"><br>
